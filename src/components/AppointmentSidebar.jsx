  ...
  return (
    <aside className="confirmacion-tarjeta" aria-labelledby="tarjeta-titulo">
      ...
      <ul className="tarjeta-lista-beneficios">
        <li className="beneficio-item"><span className="beneficio-icono" aria-hidden="true">✓</span>Estado visible en tu panel</li>
        <li className="beneficio-item"><span className="beneficio-icono" aria-hidden="true">✓</span>Agenda siempre actualizada</li>
