...
public class EmailVerificationToken {
    ...
    public static EmailVerificationToken create(
        ...
        return new EmailVerificationToken(user, tokenHash, expiresAt, createdAt);
    }

    private EmailVerificationToken(UserAccount user, String tokenHash, Instant expiresAt, Instant createdAt) {
        this.user = user;
